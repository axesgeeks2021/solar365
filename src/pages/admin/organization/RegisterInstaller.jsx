    ...
    return (
        <div style={{ width: "100%", display: 'flex', justifyContent: 'center' }}>
            ...
            <div style={{ width: '100%', padding: '20px 10px' }}>
                <Button title="Add New Installer / Electrician" background="green" margin="4px 0" color="white" onclick={() => setShowForm(!showForm)} />
                <ul className="responsive-table">
                    ...
                    </li>
                    {
                        installerList?.map((ele, idx) => {
                            return (
                                <Link to="/installer-details" state={{ele}} key={idx}>
